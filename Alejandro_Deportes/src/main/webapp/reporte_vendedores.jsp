...
<!--             <div class="col-md-3">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Cantidad de Ventas por Vendedor</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Valor Total de Ventas por Vendedor</h6>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        function fetchRankingData() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var vendedores = response || [];
                    renderTable(vendedores);
                    renderCharts(vendedores); // Renderizar ambos gráficos
                },
                error: function() {
        ...
        function renderTable(vendedores) {
            ...
            $.each(vendedores, function(index, vendedor) {
                var fila = '<tr>' +
                    ...
                    '<td>$ ' + vendedor.totalVentas.toFixed(2) + '</td>' +
                    '</tr>';
        ...
        function renderCharts(vendedores) {
            ...
            $('.card-body:eq(0)').append('<canvas id="cantidadVentasChart" width="400" height="150"></canvas>');
            ...
            var totalesVentas = vendedores.map(function(vendedor) {
                return vendedor.cantidadVentas;
            });
            var totalesValor = vendedores.map(function(vendedor) {
                return vendedor.totalVentas;
            });

            // Primer gráfico: Cantidad de Ventas por Vendedor
            var ctxCantidadVentas = $('#cantidadVentasChart')[0].getContext('2d');
            new Chart(ctxCantidadVentas, {
                type: 'bar',
                data: {
                    labels: nombres,
                    datasets: [{
