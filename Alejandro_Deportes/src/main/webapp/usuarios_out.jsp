...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div
			...
			<h6 class="m-0 font-weight-bold text-primary">Usuarios de
				Alejandro Deportes</h6>
		</div>
		<div class="card-body">
			<div class="filter-options mb-3" style="float: left">
				<a href="usuarios?filtro=activos" class="btn btn-primary">Mostrar
					Activos</a> <a href="usuarios?filtro=todos" class="btn btn-secondary">Mostrar
					Todos</a>
			</div>
			<div style="float: right">
				<!-- Botón para abrir el modal de alta de usuario -->
				<a href="#" class="btn btn-primary btn-circle mr-2"
					id="btnAltaUsuario" data-toggle="modal"
					data-target="#altaUsuarioModal"> <i class="fas fa-plus"></i>
				</a>
				<!-- Botón para abrir el modal de edición de usuario -->
				<a href="#" class="btn btn-warning btn-circle mr-2"
					id="btnEditarUsuario"> <i class="fas fa-edit"></i>
				</a>
				<!-- Botón para eliminar usuario -->
				<a href="#" class="btn btn-danger btn-circle"
					id="btnEliminarUsuario"> <i class="fas fa-trash-alt"></i>
				</a>
			</div>
			<div class="table-responsive">
				<table class="table table-bordered" id="dataTableUsers" width="100%"
					cellspacing="0">
					<thead>
						<tr>
	...
	<div class="modal fade" id="altaUsuarioModal" tabindex="-1"
		role="dialog" aria-labelledby="altaUsuarioModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="altaUsuarioModalLabel">Nuevo
						Usuario</h5>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div style="display: none;" class="form-group">
									<label for="usuarioId">ID</label> <input type="text"
										class="form-control" id="usuarioId" name="usuarioId">
								</div>
								...
								<div class="form-group">
									<label for="password" class="required">Contraseña</label> <input
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="idRol" class="required">Rol</label> <select
	...
	<script>
		...
		function llenarFormularioUsuario(data) {
			...
			setSelectOption('#idRol', usuario.rol.nombre, usuario.rol.idRol);
		}
