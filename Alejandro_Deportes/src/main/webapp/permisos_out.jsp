...
<div class="container-fluid">
	<div class="card shadow mb-4">
		<div
			...
			<h6 class="m-0 font-weight-bold text-primary">Permisos del
				Sistema</h6>
		</div>
		<div class="card-body">
			<div class="filter-options mb-3" style="float: left">
				<a href="permisos?filtro=activos" class="btn btn-primary">Mostrar
					Activos</a> <a href="permisos?filtro=todos" class="btn btn-secondary">Mostrar
					Todos</a>
			</div>

			<div style="float: right">
				<a href="#" class="btn btn-primary btn-circle mr-2"
					id="btnAltaPermiso" data-toggle="modal"
					data-target="#altaPermisoModal"> <i class="fas fa-plus"></i>
				</a> <a href="#" class="btn btn-warning btn-circle mr-2"
					id="btnEditarPermiso"> <i class="fas fa-edit"></i>
				</a> <a href="#" class="btn btn-danger btn-circle"
					id="btnEliminarPermiso"> <i class="fas fa-trash-alt"></i>
				</a>
			</div>

			<div class="table-responsive">
				<table class="table table-bordered" id="dataTablePermiso"
	...
	<div class="modal fade" id="altaPermisoModal" tabindex="-1"
		role="dialog" aria-labelledby="altaPermisoModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="altaPermisoModalLabel">Nuevo
						Permiso</h5>
